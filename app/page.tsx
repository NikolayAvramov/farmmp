...
import { dbListCrops } from "@/lib/supabase/server-queries";
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <StatCard href="/tasks" label="Чакащи задачи" value={c.pendingTasks} />
        <StatCard href="/inventory" label="Артикули" value={c.inventoryLines} />
        <StatCard href="/sales" label="Клиенти" value={c.customers} />
      </div>
      ...
      <div className="mt-8 flex flex-col gap-3">
        ...
        <Link
          href="/todos"
          className="text-center text-sm font-semibold text-farm-moss underline-offset-2 hover:underline"
        >
          Демо: бележки (todos)
        </Link>
      </div>
